...
class Settings(BaseSettings):
    ...
    cors_origins: str = "http://localhost:3010,http://localhost:3000,http://127.0.0.1:3010,http://127.0.0.1:3000,https://nwaizugbechukwuebuka.github.io,https://*.github.io,https://secureops-ai-frontend.vercel.app"
