...
class TestGetPipelines:
    ...
    def test_get_pipelines_with_pagination(self, mock_service, auth_headers):
        ...
        response = client.get("/api/v1/pipelines/?skip=10&limit=5", headers=auth_headers)
    ...
    def test_get_pipelines_with_filters(self, mock_service, auth_headers):
        ...
        response = client.get("/api/v1/pipelines/?active_only=true", headers=auth_headers)
...
class TestCreatePipeline:
    ...
    def test_create_pipeline_invalid_content_type(self, auth_headers, sample_pipeline_data):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=sample_pipeline_data, headers={**auth_headers, "Content-Type": "text/plain"}
        )
    ...
    def test_create_pipeline_missing_fields(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=incomplete_data, headers={**auth_headers, "Content-Type": "application/json"}
        )
    ...
    def test_create_pipeline_empty_body(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json={}, headers={**auth_headers, "Content-Type": "application/json"}
        )
...
class TestGetPipelineRuns:
    ...
    def test_get_pipeline_runs_with_pagination(self, auth_headers):
        ...
        response = client.get("/api/v1/pipelines/1/runs?page=2&per_page=5", headers=auth_headers)
...
class TestTriggerPipeline:
    ...
    def test_trigger_pipeline_success(self, auth_headers):
        ...
        trigger_data = {"trigger_type": "manual", "branch": "main"}
    ...
    def test_trigger_pipeline_invalid_content_type(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/1/trigger", json=trigger_data, headers={**auth_headers, "Content-Type": "text/plain"}
        )
...
class TestPipelineIntegration:
    ...
    def test_pagination_consistency(self, mock_service, auth_headers):
        ...
        for per_page in [1, 2, 5, 10]:
            response = client.get(f"/api/v1/pipelines/?limit={per_page}", headers=auth_headers)
            assert response.status_code == 200
...
class TestPipelineEdgeCases:
    ...
    def test_pipeline_name_length_limits(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=long_name_data, headers={**auth_headers, "Content-Type": "application/json"}
        )
    ...
    def test_empty_pipeline_name(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=empty_name_data, headers={**auth_headers, "Content-Type": "application/json"}
        )
    ...
    def test_invalid_repository_url(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=invalid_url_data, headers={**auth_headers, "Content-Type": "application/json"}
        )
    ...
    def test_special_characters_in_pipeline_data(self, auth_headers):
        ...
        response = client.post(
            "/api/v1/pipelines/", json=special_char_data, headers={**auth_headers, "Content-Type": "application/json"}
        )
