    ...
    try:
        ...
        dashboard_data = DashboardSummary(
            ...
            alert_metrics=AlertMetrics(
                ...
                open_alerts=15,
                resolved_alerts=74,
                alerts_by_severity={"critical": 5, "high": 18, "medium": 31, "low": 35},
                recent_alerts=12,
            ),
...
async def get_vulnerability_report(
    ...
    try:
        ...
        logger.info(
            f"Vulnerability report retrieved for user {current_user.id}, returned {len(filtered_vulnerabilities)} items"
        )
...
async def get_compliance_report(
    ...
    try:
        ...
        compliance_data = {
            ...
            "not_applicable": 6,
            "categories": {
                "Access Control": {"score": 85, "passed": 17, "failed": 3, "total": 20},
                "Data Protection": {
                    "score": 72,
                    "passed": 13,
                    "failed": 5,
