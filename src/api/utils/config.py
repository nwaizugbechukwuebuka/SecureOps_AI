...
class Settings(BaseSettings):
    ...
    secure_content_type_nosniff: str = Field(default="true", env="SECURE_CONTENT_TYPE_NOSNIFF")
    secure_browser_xss_filter: str = Field(default="true", env="SECURE_BROWSER_XSS_FILTER")
    
    # Database
    database_url: str = Field(default="sqlite:///./secureops.db", env="DATABASE_URL")
    async_database_url: str = Field(default="sqlite+aiosqlite:///./secureops.db", env="ASYNC_DATABASE_URL")
    ...
    log_forward_splunk_enabled: bool = Field(default=False, env="LOG_FORWARD_SPLUNK_ENABLED")
    ...
    log_forward_splunk_token: Optional[str] = Field(default=None, env="LOG_FORWARD_SPLUNK_TOKEN")
    ...
    # Security Scanning
    enable_dependency_scanning: bool = Field(default=True, env="ENABLE_DEPENDENCY_SCANNING")
